...
2. AI Use Case Generator — An interactive demo where users describe a business problem and receive a structured AI-generated response including a problem summary, 2–3 AI opportunities, and expected business impact. The input is sent to the backend, which calls the Groq API and streams the result back to the frontend.
